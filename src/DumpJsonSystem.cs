...
public class DumpJsonSystem : ModSystem {
  ...
  private void OnLogMessage(EnumLogType logType, string message,
    ...
    FieldInfo pkt_srvrassetsField =
        typeof(ClientSystemStartup)
            .GetField("pkt_srvrassets",
                      BindingFlags.Instance | BindingFlags.NonPublic);
    Packet_ServerAssets pkt_srvrassets =
        (Packet_ServerAssets)pkt_srvrassetsField.GetValue(startup);

    string dumpPath = Path.Combine(GamePaths.Logs, "dump");
    ...
    DumpBlocks(pkt_srvrassets.Blocks, pkt_srvrassets.BlocksCount, serializer,
               blocksPath);
    ...
    DumpItems(pkt_srvrassets.Items, pkt_srvrassets.ItemsCount, serializer,
              itemsPath);
    ...
    DumpEntities(pkt_srvrassets.Entities, pkt_srvrassets.EntitiesCount,
    ...
    DumpRecipes(pkt_srvrassets.Recipes, pkt_srvrassets.RecipesCount, serializer,
                recipesPath);
  }
